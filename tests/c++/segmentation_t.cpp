...
TEST_CASE("Median_calculation for 14 values including negative", "[segmentation]")
{
  std::vector<double> subsignal {9.0, 1, 9, 2, 8, 3, 74, 4, 6, 3, -34, 56, -25, -7};
  double mean = median_calculation(subsignal);
  REQUIRE(std::abs(mean - 3.5) < 1e-8);
}

TEST_CASE("Median_calculation for 13 values including negative", "[segmentation]")
{
...
TEST_CASE("Local maxima calculation", "[segmentation]")
{
  std::vector<double> subsignal {
        -8.75263237, -12.4498439 ,  -5.95124875,  -7.85988551,
        -6.3420341 ,  -8.12835494,  -9.1555907 ,  -8.99132828,
        -8.23779461,  -7.04616777, -10.19556631,  -7.24568867,
        -9.96439281,  -7.82714118,  -9.66504466,  -9.18525009,
        -8.98032933, -12.49556549,  -7.24393337,  -7.43629618,
       -12.44862489, -11.26010483, -14.71118047, -12.66358088,
       -11.4180224 ,  -9.89459227,  -9.25428397, -10.98106482,
       -12.24054219, -14.11235437,  -9.67368203,  -8.89575981,
        -9.09613235, -12.36181265, -10.65832827, -12.23607436,
       -12.05403716,  -8.41956718,  -5.18927969,  -3.46317324,
        -5.34923737,  -4.53456195,  -9.19263727,  -7.17482253,
        -2.20532421,  -7.37874326,  -1.53594652,  -5.11036   ,
        -2.87127928,  -2.6068047 ,  -5.79774031,  -2.94577185,
        -1.80551765,  -5.97307174,  -3.47239943,  -5.97743071,
        -1.37331331,  -5.36262128, -10.04554594, -14.0063941 ,
       -12.06269672, -10.97716596,  -8.74879272,  -9.3208788 ,
       -10.17981112,  -9.29126698, -13.14586401,  -8.59697448,
       -10.69016884, -10.05068367, -14.70860228, -10.17570982,
        -9.95747217, -13.48605285,  -8.98073346,  -7.88617972,
       -12.61344823,  -8.60895198,   0.30669687,  -3.8899    ,
        -3.17765681,  -2.41072433,  -2.38724579,  -3.01936097,
        -5.28568242,  -5.27564404,  -1.32490158,  -6.90442492,
        -0.18194116,  -3.49999513,  -3.92970908,  -7.39331718,
        -2.20850241,  -2.95758654,  -1.05819608,  -3.44517988,
        -3.48499704,  -2.39362274,  -3.29244654,  -3.5994971 };
  IndexType order1 = 1;
  IndexType order2 = 2;
  IndexType order3 = 3;
  IndexType order4 = 4;
  ...
  std::vector<IndexType> result10 = local_maxima_calculation(subsignal, order10);
  std::vector<IndexType> result11 = local_maxima_calculation(subsignal, order11);
  std::vector<IndexType> result12 = local_maxima_calculation(subsignal, order12);
  std::vector<IndexType> result21 = local_maxima_calculation(subsignal, order21);
  std::vector<IndexType> result22 = local_maxima_calculation(subsignal, order22);
    
  std::vector<IndexType> true_result1 {2, 4, 9, 11, 13, 16, 18, 21, 26, 31, 34, 39, 41, 44, 46, 49, 52, 54, 56, 62, 65, 67, 69, 72, 75, 78, 82, 86, 88, 92, 94, 97};
  std::vector<IndexType> true_result2 {2, 9, 18, 26, 31, 39, 46, 49, 52, 56, 62, 67, 75, 78, 82, 88, 94, 97};
  std::vector<IndexType> true_result3 {9, 18, 26, 31, 39, 46, 52, 56, 62, 67, 78, 82, 88, 94};
  std::vector<IndexType> true_result4 {9, 18, 26, 31, 39, 46, 56, 62, 67, 78, 88, 94}; 
...
TEST_CASE("Calculation cost L1", "[segmentation]")
{
  ...
  signal << -8.75263237, -12.4498439 ,  -5.95124875,  -7.85988551,
            -6.3420341 ,  -8.12835494,  -9.1555907 ,  -8.99132828,
            -8.23779461,  -7.04616777, -10.19556631,  -7.24568867;
...
TEST_CASE("Fit change point detection", "[segmentation]")
{
  ...
  signal << 5.89091385,  3.09297892,  7.54350943,  5.70123322, 11.45957527,
            6.65151675,  6.66711702,  4.32121252,  5.36729293,  6.3855735 ,
            6.15007257,  4.60662807,  2.93636227,  5.14934393,  4.08923314,
            8.09501888,  7.34253289,  4.77373406,  4.23434058,  6.46301976;
  ...
  std::vector<double> true_value1 {0.7606029 , 0.9658838 , 0.89199268, 1.28422382, 1.83171059,
       0.50144418, 0.78277964, 0.76066486, 1.9793425 , 2.06083943,
       0.54271586, 2.73590482, 3.25329975, 0.37560987};
...
TEST_CASE("Predict change point detection", "[segmentation]")
{
  ...
  signal << -9.30567119,  -6.50542506,  -5.25334064,  -3.95708071,
       -10.62295044,  -6.00679331,  -7.10972198,  -4.75825001,
        -6.7100845 ,  -8.11943878,  -9.56607421,  -4.94672353,
        -6.67989247,  -4.65803801,  -7.37845623,  -7.48818285,
        -5.78868842,  -5.63853894,  -6.82157223,  -4.36439707,
       -10.23610407,  -7.17848293, -10.35211983, -11.3509054 ,
       -11.61486292,  -9.35727084, -10.34027666, -10.86800044,
        -9.93429977,  -8.48897875, -15.3695928 , -14.26784041,
        -9.31700749, -10.71438333,  -6.79820964,  -9.38362261,
       -10.55322992, -10.752245  , -13.40571741, -14.18765576,
        -9.54996564, -19.35102448, -20.7635553 , -19.26623954,
       -20.00548551, -17.99023991, -18.37537823, -17.53357472,
       -23.12740104, -17.55591524, -20.86915052, -17.75074536,
       -20.28542954, -20.5310157 , -18.73412243, -19.07024164,
       -20.43017388, -21.11249791, -18.45269281, -18.07089436,
       -19.96608851, -26.63058919, -28.97962105, -25.47049917,
       -26.02732842, -25.42334059, -24.96684487, -22.69612178,
       -24.85381947, -25.34017963, -27.46753899, -24.05766122,
       -29.416168  , -19.5100961 , -25.98309514, -26.24838995,
       -25.40961916, -23.21292358, -26.63478854, -29.04883697,
       -16.35986185, -12.87413666, -16.2863866 , -15.55762212,
       -21.88964465, -17.68327092, -16.60648862, -13.49961018,
       -15.97483962, -17.23104101, -18.17963806, -16.19978101,
       -17.62239823, -17.14176606, -14.73581351, -14.62187256,
...
TEST_CASE("Fit predict change point detection", "[segmentation]")
{
  ...
  ChangePointDetectionData data { signal, window_width1, min_size1, jump1, penalty1};
