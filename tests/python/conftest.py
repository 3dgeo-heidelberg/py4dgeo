...
epochs_las = epoch_fixture("plane_horizontal_t1.laz", "plane_horizontal_t2.laz")
epochs_las_w_normals = epoch_fixture("plane_horizontal_t1_w_normals.laz", "plane_horizontal_t2_w_normals.laz")
